...
echo "<tr><td>กราฟแสดงลักษณะการติดตาม</font></td></tr><br><br>";
echo "<tr><td>ช่วงวันที่  $startdate  ถึง   $enddate</td></tr><br><br>";
	...
	// Fetch all factory records
		$strQuery = "SELECT f.follow_name,count(f.follow_id) as count_follow_id
FROM
register_risk r
 ...
 */     
			$strXML .= "<set label='" . $ors['follow_name'] . "' value='" . $ors['count_follow_id'] . "' />";
			//free the resultset
