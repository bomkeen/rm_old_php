...
echo "<tr><td>กราฟจำนวนความเสี่ยงหัวข้อย่อย</font></td></tr><br><br>";
echo "<tr><td>ช่วงวันที่  $startdate  ถึง   $enddate</td></tr><br><br>";
	...
	// Fetch all factory records
		$strQuery = "SELECT ps.prorisk_sub_detail_name ,count(ps.prorisk_sub_detail_id) as count_prorisk_sub_detail_id ,ps.prorisk_sub_detail_id
...
where r.`date` between '$startdate'and'$enddate' and ps.prorisk_detail_id = $prorisk_detail_id  
  group by ps.prorisk_sub_detail_id
        ";
 ...
 */     
			$strXML .= "<set label='" . $ors['prorisk_sub_detail_name'] . "' value='" . $ors['count_prorisk_sub_detail_id'] . "' />";
			//free the resultset
