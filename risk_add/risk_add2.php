...
-->
                ...
                <input type="hidden" value="<?php echo $iddepartweb ; ?>" name="person_id" />
                <input type="hidden" value="<?php echo $codedepart ; ?>" name="ward_reg" /> <!--  อันนี้ น่าจะมาจากการ login รหัสแผนก-->
