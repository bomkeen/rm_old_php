...
<FONT SIZE="3" COLOR="#009900">เข้าระบบโดย <?echo $yourname?> แผนก <?echo $yourdep?> สังกัดทีม <?echo $yourdep_sec?></FONT>
        <form METHOD="POST" ACTION="custom_report_view.php">
			...
			<table bgcolor="#a8d8f1" border="0" width="800" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td bgcolor="#2ba5e6" align="center" colspan="4"><font size=4 face=Tahoma, MS Sans Serif>เลือกวันในการดูข้อมูล </font> </td>
            ...
            <td>ถึงวันที่</td><td><script>DateInput('enddate', true, 'YYYY-MM-DD'
                    ...
                    <td align="center" colspan="2">
                      	 <SELECT NAME="ward_id" class="validate[required]">
                            <OPTION VALUE="%">เลือกแผนกที่รายงาน</OPTION>
			<?
												include "../function/connect.php";
...
?>
					 ...
					 <td align="center" colspan="2">
                      	 <SELECT NAME="wardedit_id" class="validate[required]">
                            <OPTION VALUE="%">เลือกแผนกที่เกิดความเสี่ยง</OPTION>
			<?
												include "../function/connect.php";
													mysql_query("set NAMES tis620");
												$sql = "select * from code_complaint";
...
<SELECT NAME="person_id" class="validate[required]">
                            <OPTION VALUE="%">ผู้รายงานความเสี่ยง</OPTION>
			<?
												include "../function/connect.php";
													mysql_query("set NAMES tis620");
