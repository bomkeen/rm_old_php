...
where  r.`date` between '$startdate'and'$enddate' and r.person_id in (SELECT id FROM pd_depart WHERE codedepart ='$codedepart') ";
...
<!-- <?echo $enddate ?>  -->
<center><a href="./person_in_dep_print.php?person_edit=<?echo $iddepartweb?>&enddate=<?echo $enddate?>&startdate=<?echo $startdate?>" target='blank'><img src="../img/excel.jpg" width="30" height="30" border="0" alt="Print"><font size="6" color="#99cc00">Excel Export</font></a></center>
...
<td width=50 align=center><font size=2 face=Tahoma, MS Sans Serif><CENTER><B>[แก้ไขข้อมูล]</B></CENTER></font></td>
...
<td width=50 align=center><font size=2 face=Tahoma, MS Sans Serif><A HREF=\"edit.php?id=$id\">[แก้ไข]</A></td>
