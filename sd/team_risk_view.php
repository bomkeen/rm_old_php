...
where  r.`date` between '$startdate' and '$enddate' and r.wardedit_id = '$dep_sec' and r.wardedit_id is not null
";
...
<center><a href="./team_risk_print.php?dep_sec=<?echo $dep_sec?>&enddate=<?echo $enddate?>&startdate=<?echo $startdate?>" target='blank'><img src="../img/excel.jpg" width="30" height="30" border="0" alt="Print"><font size="6" color="#99cc00">Excel Export</font></a></center>
