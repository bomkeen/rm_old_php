...
where  r.`date` between '$startdate' and '$enddate' and r.wardedit_id = '$codedepart'  and r.wardedit_id is not null
";
...
<?echo $dep_sec ?>
<center><a href="./dep_risk_print.php?dep=<?echo $codedepart?>&enddate=<?echo $enddate?>&startdate=<?echo $startdate?>" target='blank'><img src="../img/excel.jpg" width="30" height="30" border="0" alt="Print"><font size="6" color="#99cc00">Excel Export</font></a></center>
