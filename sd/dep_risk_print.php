...
where  r.`date` between '$startdate' and '$enddate' and r.wardedit_id = '$dep'  and r.wardedit_id is not null  ") 
or die ('data retrieval broke - '.mysql_error());
            ...
            $workbook->close();
                ...
                header("Content-Disposition: attachment; filename=".basename("ความเสี่ยงของแผนกตามช่วงเวลา.xls").";");
