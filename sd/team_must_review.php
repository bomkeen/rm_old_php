...
where  r.wardedit_id = '$dep_sec' and r.wardedit_id is not null and r.follow_id !='1' ";
...
<center><a href="./team_must_review_print.php?dep_sec=<?echo $dep_sec?>&enddate=<?echo $enddate?>&startdate=<?echo $startdate?>" target='blank'><img src="../img/excel.jpg" width="30" height="30" border="0" alt="Print"><font size="6" color="#99cc00">Excel Export</font></a></center>
